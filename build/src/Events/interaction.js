...
exports.default = new Events_1.Event("interactionCreate", (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    if (interaction.isCommand()) {
        ...
        if (isCommandOnCooldown) {
            return interaction.followUp(`This comand is currently on cooldown. Wait ${Math.floor((command === null || command === void 0 ? void 0 : command.cooldown) / (1000 * 60))} minute(s)`.concat((command === null || command === void 0 ? void 0 : command.cooldown) % 60000 !== 0
                ? ` and ${(command === null || command === void 0 ? void 0 : command.cooldown) % 60000} second(s)`
                : ""));
        }
        yield command.run({
