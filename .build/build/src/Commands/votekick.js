...
exports.default = new Commands_1.Command({
  ...
  run: ({ interaction }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    }).setTimestamp().setThumbnail(user === null || user === void 0 ? void 0 : user.displayAvatarURL()).addFields({ name: "Reason", value: reason ? reason : "No reason" }).setAuthor({
    ...
    setTimeout(() => {
      var _a2, _b, _c, _d;
      let votesYes = (_b = (_a2 = voteEmbed.reactions.cache.get("\u2705")) === null || _a2 === void 0 ? void 0 : _a2.count) !== null && _b !== void 0 ? _b : 0;
      ...
      if (votesYes > votesNo && votesYes - votesNo >= 3) {
        member.kick();
        const afterkicking = new discord_js_1.MessageEmbed().setColor("RED").setTitle("We kicked " + member.displayName).setThumbnail(member.displayAvatarURL()).addFields({
          name: "Reason",
          value: reason ? reason : "No reason"
        }).setDescription("Nobody will miss them").addFields({ name: "Votes in favour: ", value: (votesYes - 1).toString() }, { name: "Votes against: ", value: (votesNo - 1).toString() }).setTimestamp();
        interaction.followUp({ embeds: [afterkicking] });
      } else {
        const notKicked = new discord_js_1.MessageEmbed().setColor("GREEN").setTitle("You are safe " + member.displayName).setThumbnail(member.displayAvatarURL()).setDescription("For now...").addFields({ name: "Votes in favour: ", value: (votesYes - 1).toString() }, { name: "Votes against: ", value: (votesNo - 1).toString() }).setTimestamp();
