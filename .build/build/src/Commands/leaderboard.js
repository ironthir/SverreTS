...
exports.default = new Commands_1.Command({
  ...
  run: ({ interaction }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    }).setTimestamp().setThumbnail(`https://cdn.discordapp.com/icons/${(_c = interaction.guild) === null || _c === void 0 ? void 0 : _c.id}/${(_d = interaction.guild) === null || _d === void 0 ? void 0 : _d.icon}`).setAuthor({
